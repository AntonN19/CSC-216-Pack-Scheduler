...
//		}
		...
		//Valid set of null instructorId
	...
	public void testCompareTo() {
		...
		Course c4 = new Course(NAME, TITLE, "000", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		assertTrue(c4.compareTo(c1) < 0);
		Course c5 = new Course("PY208", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		assertTrue(c5.compareTo(c1) > 0);
		Course c6 = new Course("BUS420", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
