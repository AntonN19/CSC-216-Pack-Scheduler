...
/**
 * Test class for the LinkedListRecursive Test
 * 
 * @author Anton
 */
public class LinkedListRecursiveTest {

	/** String to be added to ArrayList for testing */
	...
	/**
	 * Test made to check that the size of arrayList is set to 0 when it is first
	 * constructed
	 */
	@Test
	public void testConstructor() {
		LinkedListRecursive<String> newList = new LinkedListRecursive<String>();
		assertEquals(0, newList.size());
	}

	/**
	 * Testing the ArrayList add/remove/get/set methods.
	 */
	@Test
	public void testAddRemoveGetSet() {
		...
		assertTrue(newList.remove("String 4"));
		assertEquals(1, newList.size());
		// Test the valid set functionality.
		assertEquals("String 2", newList.set(0, str1)); // 1
		assertEquals("String 1", newList.set(0, str2)); //2 
		assertTrue(newList.add(str1)); //2 1
		assertEquals("String 1", newList.set(1, str4)); // 2 4
...
//		}
	...
	/**
	 * Tests that the list can grow to a size larger than it's initial size without
	 * losing information.
	 */
	@Test
