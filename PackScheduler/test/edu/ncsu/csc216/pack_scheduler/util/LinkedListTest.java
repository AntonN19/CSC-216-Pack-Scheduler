...
/**
 * Contains unit tests for the LinkedList class and its methods
 * 
...
public class LinkedListTest {
	...
	/**
	 * Test made to check that the size of arrayList is set to 0 when it is first constructed
	 */
	@Test
	...
	/**
	 * Tests various LinkedListIterator methods
	 */
	@Test
	public void testIteratorMethods() {
		...
		// Test exception throws in remove() and set()
		iterator.remove();
		iterator.add("S");
		try {
			iterator.remove();
